...
000000008020000c <kern_init>:
    ...
    80200038:	9b450513          	addi	a0,a0,-1612 # 802009e8 <etext+0x1a>
...
void print_kerninfo(void) {
    ...
    802000a6:	94e50513          	addi	a0,a0,-1714 # 802009f0 <etext+0x22>
void print_kerninfo(void) {
    ...
    80200126:	96e50513          	addi	a0,a0,-1682 # 80200a90 <etext+0xc2>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    8020015a:	96a50513          	addi	a0,a0,-1686 # 80200ac0 <etext+0xf2>
}
...
void print_regs(struct pushregs *gpr) {
    ...
    802001a2:	a2250513          	addi	a0,a0,-1502 # 80200bc0 <etext+0x1f2>
void print_regs(struct pushregs *gpr) {
    ...
    8020035a:	b5250513          	addi	a0,a0,-1198 # 80200ea8 <etext+0x4da>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200370:	b5450513          	addi	a0,a0,-1196 # 80200ec0 <etext+0x4f2>
void print_trapframe(struct trapframe *tf) {
    ...
    802003bc:	b6850513          	addi	a0,a0,-1176 # 80200f20 <etext+0x552>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003da:	70670713          	addi	a4,a4,1798 # 80200adc <etext+0x10e>
    ...
    802003ec:	78850513          	addi	a0,a0,1928 # 80200b70 <etext+0x1a2>
    802003f0:	c7dff06f          	j	8020006c <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003f4:	00000517          	auipc	a0,0x0
    802003f8:	75c50513          	addi	a0,a0,1884 # 80200b50 <etext+0x182>
    802003fc:	c71ff06f          	j	8020006c <cprintf>
            cprintf("User software interrupt\n");
    80200400:	00000517          	auipc	a0,0x0
    80200404:	71050513          	addi	a0,a0,1808 # 80200b10 <etext+0x142>
    80200408:	c65ff06f          	j	8020006c <cprintf>
            cprintf("Supervisor software interrupt\n");
    8020040c:	00000517          	auipc	a0,0x0
    80200410:	72450513          	addi	a0,a0,1828 # 80200b30 <etext+0x162>
    ...
    8020041c:	78850513          	addi	a0,a0,1928 # 80200ba0 <etext+0x1d2>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200446:	bcf6b723          	sd	a5,-1074(a3) # 80204010 <edata>
    ...
    80200460:	73450513          	addi	a0,a0,1844 # 80200b90 <etext+0x1c2>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005c4:	b0878793          	addi	a5,a5,-1272 # 802010c8 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200618:	920a0a13          	addi	s4,s4,-1760 # 80200f34 <etext+0x566>
    ...
    80200624:	a70c0c13          	addi	s8,s8,-1424 # 80201090 <error_string>
    ...
    80200712:	a6a60613          	addi	a2,a2,-1430 # 80201178 <error_string+0xe8>
    ...
    802008a6:	8c660613          	addi	a2,a2,-1850 # 80201168 <error_string+0xd8>
    ...
    802008b8:	8ac60613          	addi	a2,a2,-1876 # 80201160 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    802008bc:	00001417          	auipc	s0,0x1
    802008c0:	8a540413          	addi	s0,s0,-1883 # 80201161 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    8020094c:	81940413          	addi	s0,s0,-2023 # 80201161 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
void sbi_set_timer(unsigned long long stime_value) {
    ...
    8020099a:	68278793          	addi	a5,a5,1666 # 80204018 <SBI_SET_TIMER>
    __asm__ volatile (
