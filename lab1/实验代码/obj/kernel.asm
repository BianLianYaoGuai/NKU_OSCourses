...
int kern_init(void) {
    ...
    80200038:	9c450513          	addi	a0,a0,-1596 # 802009f8 <etext+0x1e>
...
void print_kerninfo(void) {
    ...
    802000a6:	95e50513          	addi	a0,a0,-1698 # 80200a00 <etext+0x26>
void print_kerninfo(void) {
    ...
    80200126:	97e50513          	addi	a0,a0,-1666 # 80200aa0 <etext+0xc6>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    8020015a:	97a50513          	addi	a0,a0,-1670 # 80200ad0 <etext+0xf6>
}
...
void print_regs(struct pushregs *gpr) {
    ...
    802001a2:	a4250513          	addi	a0,a0,-1470 # 80200be0 <etext+0x206>
void print_regs(struct pushregs *gpr) {
    ...
    8020035a:	b7250513          	addi	a0,a0,-1166 # 80200ec8 <etext+0x4ee>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200370:	b7450513          	addi	a0,a0,-1164 # 80200ee0 <etext+0x506>
void print_trapframe(struct trapframe *tf) {
    ...
    802003bc:	b8850513          	addi	a0,a0,-1144 # 80200f40 <etext+0x566>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003da:	71670713          	addi	a4,a4,1814 # 80200aec <etext+0x112>
    ...
    802003ec:	79850513          	addi	a0,a0,1944 # 80200b80 <etext+0x1a6>
    802003f0:	c7dff06f          	j	8020006c <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003f4:	00000517          	auipc	a0,0x0
    802003f8:	76c50513          	addi	a0,a0,1900 # 80200b60 <etext+0x186>
    802003fc:	c71ff06f          	j	8020006c <cprintf>
            cprintf("User software interrupt\n");
    80200400:	00000517          	auipc	a0,0x0
    80200404:	72050513          	addi	a0,a0,1824 # 80200b20 <etext+0x146>
    80200408:	c65ff06f          	j	8020006c <cprintf>
            cprintf("Supervisor software interrupt\n");
    8020040c:	00000517          	auipc	a0,0x0
    80200410:	73450513          	addi	a0,a0,1844 # 80200b40 <etext+0x166>
    ...
    8020041c:	7a850513          	addi	a0,a0,1960 # 80200bc0 <etext+0x1e6>
...
if(++ticks%TICK_NUM==0)
    ...
    80200460:	74450513          	addi	a0,a0,1860 # 80200ba0 <etext+0x1c6>
...
cprintf("ShutDown!!\n");
    80200472:	00000517          	auipc	a0,0x0
    80200476:	73e50513          	addi	a0,a0,1854 # 80200bb0 <etext+0x1d6>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005d0:	b1c78793          	addi	a5,a5,-1252 # 802010e8 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200624:	934a0a13          	addi	s4,s4,-1740 # 80200f54 <etext+0x57a>
    ...
    80200630:	a84c0c13          	addi	s8,s8,-1404 # 802010b0 <error_string>
    ...
    8020071e:	a7e60613          	addi	a2,a2,-1410 # 80201198 <error_string+0xe8>
    ...
    802008b2:	8da60613          	addi	a2,a2,-1830 # 80201188 <error_string+0xd8>
    ...
    802008c4:	8c060613          	addi	a2,a2,-1856 # 80201180 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    802008c8:	00001417          	auipc	s0,0x1
    802008cc:	8b940413          	addi	s0,s0,-1863 # 80201181 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    80200958:	82d40413          	addi	s0,s0,-2003 # 80201181 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
void sbi_set_timer(unsigned long long stime_value) {
    ...
    802009a6:	66e78793          	addi	a5,a5,1646 # 80204010 <edata>
    __asm__ volatile (
